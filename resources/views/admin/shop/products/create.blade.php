...
@section('content')
    ...
    <form method="post" action="{{ route('admin.shop.products.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control @error('price') is-invalid @enderror" type="number" name="price" id="price" @error('price') placeholder="{{ $message }}" @enderror>
        </div>
        <div class="form-group">
            <label for="game_item_id" class="form-control-label">Game Item Id <span class="text-danger">*</span></label>
            <input class="form-control @error('game_item_id') is-invalid @enderror" type="number" name="game_item_id" id="game_item_id" @error('game_item_id') placeholder="{{ $message }}" @enderror>
        </div>
        <div class="mb-3">
            <div class="form-group">
        ...
        <button class="btn btn-primary" type="submit" id="create_shop_product">Create</button>
    </form>
