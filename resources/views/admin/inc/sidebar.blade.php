<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            {{--            <img src="{{ asset('adm/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100" alt="main_logo">--}}
            <span class="ms-1 font-weight-bold">Rz-synC by SyncAllow</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.index') ? 'active' : '' }}" href="{{ route('admin.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.payments.index') ? 'active' : '' }}" href="{{ route('admin.payments.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-money-coins text-lg text-dark opacity-10" aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Payments</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.settings.*') ? 'active' : '' }}" href="{{ route('admin.settings.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.servers.*') ? 'active' : '' }} " href="{{ route('admin.servers.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">News pages</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.news.*') && !\Illuminate\Support\Facades\Route::currentRouteNamed('admin.news.categories.*') ? 'active' : '' }} " href="{{ route('admin.news.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.news.categories.*') ? 'active' : '' }} " href="{{ route('admin.news.categories.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.accounts.*') ? 'active' : '' }} " href="{{ route('admin.accounts.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @foreach($globalServers as $globalServer)
                <li class="nav-item">
                    <a class="nav-link {{ \Illuminate\Support\Facades\Route::currentRouteNamed('admin.characters.index') && $globalServer->id === $server->id ? 'active' : '' }} " href="{{ route('admin.characters.index', $globalServer->id) }}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <img class="avatar" src="{{ asset('/storage/'.$globalServer->image) }}" alt="">
                        </div>
                        <span class="nav-link-text ms-1">{{ $globalServer->title }}</span>
                    </a>
                </li>
            @endforeach
            @else
